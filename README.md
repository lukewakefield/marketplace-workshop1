...
After creating a module in the Siteglide Marketplace, replace all instances of `<my_module_146>` with your new ID. You should also rename the folder `module_my_module_id` e.g. `module_145`.
